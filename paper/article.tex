...
\begin{description}
  ...
  \item[\pkg{p2a-dioxus}] Cross-platform GUI (web and desktop) with LLM integration
\end{description}
...
\begin{figure}[htbp]
\centering
\includegraphics[height=0.9\textheight,keepaspectratio]{figures/architecture_paper}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/chat_flow_paper}
