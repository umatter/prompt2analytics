...
scenarios, 84 pass (87.5\%).  Standard error calibration and Type~I
error control are exact: 34/34 SE accuracy tests and 16/16 Type~I
error tests pass.  The three failures are marginal coverage
deviations in panel FE/RE (93\% vs.\ 95\% nominal) and slightly
conservative IV confidence intervals (97.6\% coverage).
Full results and the simulation code are included in the supplementary
materials.
