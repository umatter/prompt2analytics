...
coverage is 0.951 (nominal 0.950).  The three failures are
over-conservative coverage in IV/2SLS (97.6\% at $n = 200$,
consistent with finite-sample 2SLS properties) and IPW (99.8--100\%,
indicating overly wide confidence intervals that warrant further
investigation).  Full results and the simulation code are included in
