...
scenarios, 94 pass (97.9\%).  Standard error calibration and Type~I
error control are exact: all 34 SE accuracy tests pass (mean ratio
1.004) and all 16 Type~I error tests pass.  Mean confidence interval
coverage is 0.950 (nominal 0.950).  The two failures are
IPW (99.8--100\% coverage) because the influence function treats
