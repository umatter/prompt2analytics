...
Figure~\ref{fig:e2e-improvement} shows the improvement trajectory
across infrastructure iterations.

\input{tables/tab_e2e_chrome_mt}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{figures/e2e_improvement_trajectory}
\caption{Multi-turn accuracy improvement through infrastructure fixes.
Round~1 replaced the HTTP tool match (70~tools) with full router dispatch
(268~tools).  Round~2 corrected LLM tool parameter definitions.}
