...
pub use ml::{
    ...
    BartCausalConfig,
    BartCausalResult,
    // BART (Bayesian Additive Regression Trees) for prediction
    BartConfig,
    BartResult,
    // C5.0 Decision Trees (classification with boosting, winnowing, rules)
    C50Config,
    C50Node,
    C50Result,
    C50Rule,
    ...
    CutreeResult,
    DBSCANResult,
    // Decision tree internals (for SHAP)
    DecisionTree,
    ...
    GbmResult,
    HierarchicalResult,
    // ICE curves (Individual Conditional Expectation) - Goldstein et al. 2015
    IceConfig,
    IceResult,
    IceSpread,
    // LightGBM
    ...
    PprConfig,
    PprResult,
    // Random Forest with trees (for SHAP)
    RandomForestModel,
    RandomForestResult,
    RocAucResult,
    RuleCondition,
    ...
    // BART for prediction (Chipman, George & McCulloch 2010)
    bart,
    bart_arrays,
    ...
    fast_svm,
    fast_xgboost,
    fast_xgboost_predict,
    gbm,
    gbm_partial_dependence,
    gbm_predict,
    ...
    // Model-based Boosting functions
    mboost,
    mboost_cv,
    mboost_predict,
    partial_dependence,
    ...
    ppr,
    random_forest,
    // Random Forest with tree storage
