...
pub use ml::{
    ...
    CausalForestConfig,
    CausalForestResult,
    // Model Evaluation (ROC/AUC, Confusion Matrix, Variable Importance, Partial Dependence)
    ...
    DBSCANResult,
    FastKernel,
    // Fast MBoost (parallel)
    FastMboostConfig,
    FastMboostFamily,
    FastMboostLearner,
    FastMboostResult,
    // Fast implementations (optimized algorithms)
    FastRocAucResult,
    FastSvmConfig,
    FastSvmResult,
    ...
    GbmResult,
    HierarchicalResult,
    // Model Interpretability (ICE, LIME, SHAP)
    IceCurvesResult,
    KMeansResult,
    // Kernel SVM
    KernelSvmConfig,
